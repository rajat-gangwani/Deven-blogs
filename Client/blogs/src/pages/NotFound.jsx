  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#F5F5F5] dark:bg-[#1C1C1E] transition-colors duration-700 px-4">
      <div className="text-center">
        ...
        <Link
          to="/"
          className="inline-block px-6 py-3 text-black bg-yellow-300 hover:bg-yellow-500 dark:bg-yellow-500 dark:hover:bg-yellow-600 rounded-lg shadow transition"
        >
          Go Back Home
        </Link>
      </div>
